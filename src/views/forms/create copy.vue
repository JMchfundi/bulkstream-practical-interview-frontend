...
export default {
  ...
  watch: {
    // No longer need individual watchers for formType, id, $route.query.menu
    // as computedTitle and computedItems will react automatically.
    // However, we might still want to store to localStorage for persistence
    // if 'clickedmenu' is used elsewhere for initial sidebar state.
    computedTitle: {
      immediate: true,
      handler(newTitle) {
