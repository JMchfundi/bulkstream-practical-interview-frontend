  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "client name", sortable: true },
        { key: "country", sortable: true },
        { key: "personal address", sortable: true},
        { key:  "contact", sortable: true},
        { key:  "account no.", sortable: true},
        { key: "amount requested", sortable: true },
      ...
      <div class="table-responsive">
        ...
        >
          ...
          <template v-slot:cell(action)>
            ...
            >
              <i class="mdi mdi-autorenew font-size-18"></i>
            </a>
            <a
              href="javascript:void(0);"
            ...
            <a href="javascript:void(0);" class="text-danger" v-b-tooltip.hover title="Reject request">
              <i class="mdi mdi-close-box font-size-18"></i>
            </a>
          </template>
        </b-table>
      </div>
